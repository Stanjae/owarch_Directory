...
const CBanner = () => {
  ...
  const newHeading =
    heading.split("/")[1] == "" ? "Priests" : heading.split("/")[1];

  return (
    <div className=" bg-light-overlay py-16">
      <div className="text-center max-w-3xl mx-auto space-y-5">
        <h1 className=" text-[57px] !capitalize font-bold leading-[60px] ">{newHeading}</h1>
        ...
        <Breadcrumb>
          <BreadcrumbList className=" justify-center text-center">
            ...
            <BreadcrumbItem>
              <BreadcrumbLink className=" capitalize" href={heading}>
                {newHeading}
              </BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
